...
<script type="text/javascript">
	...
	function drawChart(){
		...
		data.addColumn('string','Du an cha');
		...
		while($row=$result->fetch_assoc()){
			...
			['<?php echo $maduan; ?>','<?php echo $tenduan;?>',null,new Date(<?php echo $startduanmoi; ?>),new Date(<?php echo $endduanmoi; ?>),null,<?php echo $tiendoduan; ?>,null],
			...
			while($row0=$result0->fetch_assoc()){
				...
				['<?php echo $maduancon; ?>','<?php echo $tenduancon;?>','<?php echo $tenduan;?>',new Date(<?php echo $startduanconmoi; ?>),new Date(<?php echo $endduanconmoi; ?>),null,<?php echo $tiendoduancon; ?>,'<?php echo $maduancha; ?>'],
				 <?php } } ?>
				 ]);
