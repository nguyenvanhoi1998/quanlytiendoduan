...
<div class="container-fluid">
	<div class="row justify-content-center">
		...
		<h1 style="text-align: center;color: green">Sửa thông tin dự án</h1><br>
		<div style="border:1px solid blue;border-radius:20px;padding:30px">
			<table align="center">
				...
				<tr>
					...
					<td><textarea name="tenduan" id="tenduan" style="width:300px; height:150px;"><?=$tenduan?></textarea></td>
				</tr><tr><td></td><td><p style="color:red" id="tenduanError" class="error"></p></tr><tr><td></td></tr>
				<tr>
					<th style="color:blue;">Ngày bắt đầu: </th>
					<td><input type="date" name="startduan" id="startduan" min="2021-06-14" max="2021-08-06" value="<?=$startduan?>"></td>
				</tr><tr><td></td><td></tr><tr><td></td></tr>
				<tr>
					<th style="color:blue;">Ngày kết thúc: </th>
					<td><input type="date" name="endduan" id="endduan" min="2021-06-14" max="2021-08-06" value="<?=$endduan?>"></td>
				</tr><tr><td></td><td></tr><tr><td></td></tr></tr><tr><td></td><td></tr><tr><td></td></tr>
				</tr><tr><td></td><td></tr><tr><td></td></tr></tr><tr><td></td><td></tr><tr><td></td></tr>
				<tr>
					<td></td>
					<td>
